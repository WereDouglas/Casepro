...
namespace Casepro.Model
{
    public class Fee
    {
        ...
        public Fee(string _feeID, string _orgID, string _clientID, string _fileID, string _details, string _lawyer, string _paid, string _invoice, string _method, string _amount, string _received, string _balance, string _approved, string _signed, string _date)
        {
            this._feeID = _feeID;
            this._orgID = _orgID;
